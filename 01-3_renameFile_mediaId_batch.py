...
def batch_rename_logic():
    ...
    # 讓使用者輸入資料夾路徑
    username = [  'martinispig', 'miao11255', 'minikiki_0529', 'mr.joehobby', 'mypink0911', 'neneko.n', 'niniru621', 'peri168', 'peter825', 'sanyuan_japan', 'shaogao', 'three_muggles', 'traveggo', 'tzu_888', 'wia627', 'zxsdexz']

    for name in username:
        print(f"開始執行{name}檔案比對與轉換")
        input_dir = rf"D:\VedioOK\{name}"
